...
bool CUPnPActionFactory::BuildActionFromString(std::string p_sContent, CUPnPBrowse* pAction)
{  
    ...
    pAction->m_BrowseFlag = ubfBrowseDirectChildren;
    pAction->m_sFilter    = "*";
    ...
    pAction->m_TargetDevice = udtContentDirectory;
