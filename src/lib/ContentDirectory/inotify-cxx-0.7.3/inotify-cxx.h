...
public:
  ...
  // uv 2010-05-11
  // if a watched directory is moved the watch is still usable
  // but the path of this class is not updated so future events will
  // return an invalid event path.
  // I added this function to be able to set the correct path myself.  
  /// Sets the watched file path.
  /**
