...
CHTTPClient::CHTTPClient(IHTTPClient* pAsyncReceiveHandler, std::string name)
:Thread("HTTP client " + name), m_socket(CSharedConfig::Shared()->networkSettings->GetIPv4Address())
{
  m_bIsAsync    = false;
