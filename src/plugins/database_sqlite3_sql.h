...
static const fuppes_sql sqlite3_statements[] = {
  ...
  "  d.SIZE, d.AUDIO_CODEC, d.VIDEO_CODEC, d.V_BITRATE, "
...
*/  
  ...
  "select "
  "  o.ID, o.OBJECT_ID, o.PARENT_ID, o.DETAIL_ID, o.TYPE, "
  "CASE "
  "  WHEN o.DEVICE is NULL "
  "  THEN o.PATH "
  "  ELSE (select PATH from OBJECTS where DEVICE is NULL and OBJECT_ID = o.VREF_ID) "
  ...
  "o.TITLE, o.MD5, "
  "o.REF_ID, o.DEVICE, "
  "o.VCONTAINER_TYPE, o.VCONTAINER_PATH, "
  "o.VREF_ID, o.VISIBLE, "
  "o.MODIFIED_AT, o.UPDATED_AT, d.ID, d.PUBLISHER, d.DATE, d.DESCRIPTION, d.LONG_DESCRIPTION, "
  "d.AV_GENRE, d.AV_LANGUAGE, d.AV_ARTIST, d.AV_ALBUM, d.AV_CONTRIBUTOR, d.AV_PRODUCER, "
  "d.A_TRACK_NUMBER, d.V_ACTORS, d.V_DIRECTOR, d.V_SERIES_TITLE, d.V_PROGRAM_TITLE, d.V_EPISODE_NR, "
  "d.V_EPISODE_COUNT, d.SIZE, d.AV_DURATION, d.A_CHANNELS, d.A_BITRATE, d.A_BITS_PER_SAMPLE, "
  "d.A_SAMPLERATE, d.IV_WIDTH, d.IV_HEIGHT, d.IV_COLOR_DEPTH, d.A_YEAR, d.A_COMPOSER, d.AUDIO_CODEC, "
  "d.VIDEO_CODEC, d.V_BITRATE, d.ALBUM_ART_ID, d.ALBUM_ART_EXT, d.ALBUM_ART_MIME_TYPE, d.ALBUM_ART_WIDTH, "
  "d.ALBUM_ART_HEIGHT, d.STREAM_MIME_TYPE, d.SOURCE "
  },
